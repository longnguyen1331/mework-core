...
{
    public class FluentValidator<TValidator>  : ComponentBase where TValidator: IValidator
    {
        ...
        protected override void OnInitialized()
        {
            ...
            validator = Services.GetService<TValidator>() ?? Activator.CreateInstance<TValidator>();
