...
namespace Website.LanguageResources
{
    public class JsonStringLocalizer
    {
        ...
        private ApiCodeString GetApiCodeGetApiCode(string input)
        {
            string pattern = @"";
            ...
            if (matches.Count > 0)
            {
                ...
                foreach (Match match in matches)
                {
                    ...
                    apiCode.Values.Add(match.Groups[1].Value);
                }
